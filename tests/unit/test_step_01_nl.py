...
class TestNLParser:
    ...
    def test_with_tema_preference(self):
        result, _ = _run_nl(
            "Cool 50 kg/s of crude oil from 150°C to 90°C "
    ...
    def test_nonsense_request(self):
        result, _ = _run_nl("What is the weather today?")
        assert not result.validation_passed
